...
const FeatureCard: FC<FeatureCardProps> = ({ title, imageUrl, content, index }) => {
  return (
    <article className="w-full md:max-w-[30rem] lg:max-w-[36rem] border-2 border-transparent rounded-lg py-4 px-8 hover:bg-slate-800 hover:border-sky-600 cursor-pointer" data-aos="fade-up" data-aos-delay={index * 100}>
